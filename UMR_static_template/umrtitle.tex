...
%   
% Title of thesis:
\thesistitle{My Thesis}   
% Your full name:     
\author{Super Awesome Graduate Student}       
...
\memberone{Committe Member 1}
\membertwo{Committe Member 2}
\memberthree{Committe Member 3}
\memberfour{Committe Member 4}
